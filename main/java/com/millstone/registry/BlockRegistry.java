...
public class BlockRegistry {
	...
	// misc
	public static Block obsidianBlock = new ObsidianBlock(Material.rock)
			.setBlockName("obsidianBlock");
	public static Block lantern = new Lantern(Material.glass).setHardness(0.3F)
			.setLightLevel(1.0F).setBlockName("lantern")
			.setBlockTextureName("lantern");

	// Interactive Blocks
	public static Block millstoneIdle = new Millstone(false)
			.setBlockName("millstoneIdle")
			.setCreativeTab(MillstoneMod.tabMillstone).setHardness(5F);
	public static Block millstoneActive = new Millstone(true).setBlockName(
			"millstoneActive").setHardness(5F);;
	public static Block stoneCutter = new Cutter().setBlockName("stoneCutter")
			.setCreativeTab(MillstoneMod.tabMillstone).setHardness(5F);
	...
	public static Block lavaBrick = new LavaBrick(Material.rock).setBlockName(
			"lavaBrick").setBlockTextureName(
			References.MODID + ":" + "lavaBrick");
	public static Block Firerack = new Firerack(Material.rock).setBlockName(
			"Firerack")
			.setBlockTextureName(References.MODID + ":" + "Firerack");

	// Walls
	public static Block sandstoneWall = new WallBlock(Blocks.sandstone, 0)
			.setBlockName("sandstoneWall");
	public static Block brickWall = new WallBlock(Blocks.brick_block, 1)
			.setBlockName("brickWall");
	public static Block stoneBrickWall = new WallBlock(Blocks.stonebrick, 2)
			.setBlockName("stoneBrickWall");

	// Trees
	public static Block log = new LogBlock().setBlockName("log")
			.setCreativeTab(MillstoneMod.tabMillstone)
			.setBlockTextureName("log");
	public static Block leaf = new LeafBlock().setBlockName("leaf")
	...
	// Stairs
	public static Block willowStairs = new StairsBlock(planks, 0)
			.setBlockName("willowStairs");
	public static Block palmStairs = new StairsBlock(planks, 1)
			.setBlockName("palmStairs");
	public static Block dreadwoodStairs = new StairsBlock(planks, 2)
			.setBlockName("dreadwoodStairs");
	public static Block redwoodStairs = new StairsBlock(planks, 3)
			.setBlockName("redwoodStairs");
	public static Block applewoodStairs = new StairsBlock(planks, 4)
			.setBlockName("applewoodStairs");
	public static Block cherryStairs = new StairsBlock(planks, 5)
			.setBlockName("cherryStairs");
	public static Block baobobStairs = new StairsBlock(planks, 6)
			.setBlockName("baobobStairs");

	public static Block coloredBed = new BlockColoredBed()
			.setBlockName("coloredBed");
	...
	public static void Register() {
		...
		GameRegistry.registerBlock(planks, PlanksBlockItem.class,
				(planks.getUnlocalizedName().substring(5)));
		GameRegistry.registerBlock(log, LogBlockItem.class,
				(log.getUnlocalizedName().substring(5)));
		GameRegistry.registerBlock(leaf, LeafBlockItem.class,
				(leaf.getUnlocalizedName().substring(5)));
		// Slabs
		GameRegistry.registerBlock(doubleSlab, SlabBlockItem.class,
				"doubleSlab");
		GameRegistry.registerBlock(singleSlab, SlabBlockItem.class,
				"singleSlab");
