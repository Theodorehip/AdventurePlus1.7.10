...
public class ContainerCutter extends Container
{
    ...
    public ContainerCutter(InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5)
    {
    ...
    {
        this.craftResult.setInventorySlotContents(0, CutterCraftingManager.getInstance().findMatchingRecipe(this.craftMatrix, this.worldObj));
    }
    ...
    {
    	if(worldObj.getBlock(posX, posY, posZ) != MillstoneBlocks.stoneCutter) {
			return false;
		}else{
