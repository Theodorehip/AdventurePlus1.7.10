...
public class CutterShapedRecipes implements IRecipe
{
    ...
    public CutterShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public CutterShapedRecipes func_92100_c()
    {
