...
public class ColoredBed extends BlockDirectional{
	...
	public ColoredBed(int meta)
    {
        super(Material.cloth);
		setHardness(0.2F);
		setBlockName("coloredBed");
		disableStats();
		setBlockTextureName("coloredBed");
		this.func_149978_e();
    }
    ...
    {
        this.field_149983_N = new IIcon[] {p_149651_1_.registerIcon(References.MODID + ":" + this.getTextureName() + "_feet_top"), p_149651_1_.registerIcon(References.MODID + ":" + this.getTextureName() + "_head_top")};
        this.field_149980_b = new IIcon[] {p_149651_1_.registerIcon(References.MODID + ":" + this.getTextureName() + "_feet_end"), p_149651_1_.registerIcon(References.MODID + ":" + this.getTextureName() + "_head_end")};
        this.field_149982_M = new IIcon[] {p_149651_1_.registerIcon(References.MODID + ":" + this.getTextureName() + "_feet_side"), p_149651_1_.registerIcon(References.MODID + ":" + this.getTextureName() + "_head_side")};
    }
