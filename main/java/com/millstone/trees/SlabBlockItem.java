...
public class SlabBlockItem extends ItemBlock
{
	...
	{
		super(block);
		this.theHalfSlab = BlockRegistry.singleSlab;
		this.doubleSlab = BlockRegistry.doubleSlab;
		if(block == BlockRegistry.doubleSlab)
		{
	...
	{
		return ((SlabBlock)theHalfSlab).func_150002_b(stack.getItemDamage());
	}
