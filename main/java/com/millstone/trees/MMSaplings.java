...
public class MMSaplings extends BlockSapling {
	public static final String[] saplings = new String[] {"Redwood"};
    ...
    public void func_149878_d(World world, int x, int y, int z, Random random) {
        ...
        //Shows which case is going to execute to grow tree. Not done, Do not delete.
        switch (l) {
            case 0:
            	break;
            case 1:
            	object = new WorldGenRedwoodTree(MillstoneMod.blockLog, MillstoneMod.blockLeaf, 5, 0, false, 6, 10, false);
                break;
            case 2:
                break;
            case 3:
    ...
    public void registerBlockIcons(IIconRegister iconRegister)
    {
        ...
        {
        	iconLength[i] = iconRegister.registerIcon(References.MODID + ":"  + ":" + this.getUnlocalizedName().substring(5) + saplings[i]);
        }
    }
